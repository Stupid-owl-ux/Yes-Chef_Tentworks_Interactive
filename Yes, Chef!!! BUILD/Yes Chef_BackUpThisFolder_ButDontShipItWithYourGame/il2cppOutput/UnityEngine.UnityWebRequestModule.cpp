...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_RedirectTo_m63855E63B6B6EAFD4BCE65395BB744AAF5BD6AB4 (String_t* ___0_baseUri, String_t* ___1_redirectUri, const RuntimeMethod* method) 
{
	...
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:491>
	...
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:492>
...
IL_0015:
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:494>
...
IL_001d:
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:495>
	...
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:496>
...
IL_002c:
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:498>
		...
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:499>
		...
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:500>
		NullCheck(L_13);
		String_t* L_14;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void WebRequestUtils__cctor_m31ADEB75E00368144C8F223647D81A3B5ADD3D69 (const RuntimeMethod* method) 
{
	...
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/WebRequestUtils.cs:483>
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/CertificateHandler/CertificateHandler.bindings.cs:33>
		return (bool)0;
	}
}
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/CertificateHandler/CertificateHandler.bindings.cs:39>
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/DownloadHandler/DownloadHandler.bindings.cs:126>
		return (bool)1;
	}
}
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/DownloadHandler/DownloadHandler.bindings.cs:132>
		uint64_t L_0 = ___0_contentLength;
		VirtualActionInvoker1< int32_t >::Invoke(6, __this, ((int32_t)L_0));
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/DownloadHandler/DownloadHandler.bindings.cs:134>
		return;
	}
}
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/DownloadHandler/DownloadHandler.bindings.cs:137>
		return;
	}
}
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/DownloadHandler/DownloadHandler.bindings.cs:140>
		return;
	}
}
...
{
	{
		//<source_info:C:/build/output/unity/unity/Modules/UnityWebRequest/Public/DownloadHandler/DownloadHandler.bindings.cs:143>
		return (0.0f);
	}
}
#ifdef __clang__
